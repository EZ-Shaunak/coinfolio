            ...
            <table>
                ...
                <tbody>
                    {tokens.map((token, index) => (
                        <tr key={index}>
                            <td>{index + 1}</td>
                            <td>{token.tokenMarketDetails.name}</td>
                            <td>{token.tokenMarketDetails.symbol.toUpperCase()}</td>
                            <td>{token.tokenMarketDetails.current_price.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}</td>
                            <td>{token.balance}</td>
